        ...
        <nav class="flex h-full flex-1 flex-col space-y-1 p-2">
          ...
          <div class="flex-col flex-1 overflow-y-auto border-b border-white/20">
            <div class="flex flex-col gap-2 text-gray-100 text-sm">
              <a v-for="(thread, index) in questions" :key="index" class="
                  flex
                  py-3
                  px-3
                  items-center
          ...
          <a v-if="questions && questions.length" @click="clearStorage()" class="
              flex
              py-3
              px-3
              items-center
            ...
            </svg>{{ isConfirm.text }}</a><a @click="changeToLight()" class="
              flex
              py-3
              px-3
              items-center
          ...
          <!-- <a href="https://discord.gg/openai" target="_blank" class="
              flex
              py-3
              px-3
              items-center
          ...
          <router-link to="/" class="
              ...
              text-sm
            ">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="h-4 w-4"
              stroke="currentColor">
              <!-- <svg stroke="currentColor" fill="currentColor" stroke-width="2" viewBox="0 0 640 512" class="h-4 w-4"
              height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"> -->
